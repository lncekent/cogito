...
export default function FlashcardViewer({ flashcards, topic, summary, onBack }: FlashcardViewerProps) {
  ...
  const activeCard = flashcards && flashcards.length > 0 ? flashcards[currentIndex] : null;
    ...
    return (
      <div className="max-w-5xl mx-auto py-12 px-4 text-center">
        ...
        <div className="bg-white border border-slate-100 rounded-3xl p-8 shadow-sm">
          <p className="text-sm text-slate-500">No flashcards are available in this study session.</p>
          <button 
            onClick={onBack} 
